...
# En fonction de la clé API saisie dans le .env, la RAG-chain retrouvera les 3 documents les plus pertinents et utilisera le LLM choisi pour générer une réponse.
